...
namespace Infoware.UnitOfWork
{
        ...
        where TContext : DbContext
    {
        ...
        public IQueryable<TResult> GetAll<TResult>(Expression<Func<TEntity, TResult>> selector,
            ...
            Func<IQueryable<TEntity>, IIncludableQueryable<TEntity, object>>? include = null, bool disableTracking = true, bool ignoreQueryFilters = false)
        {
            return GetAll(predicate, orderBy, include, disableTracking, ignoreQueryFilters).Select(selector);
        }
        ...
        {
            return GetAll(predicate, orderBy, include, disableTracking, ignoreQueryFilters).ToPagedList(pageIndex, pageSize);
        }
        ...
        {
            return GetAll(predicate, orderBy, include, disableTracking, ignoreQueryFilters).ToPagedListAsync(pageIndex, pageSize, cancellationToken: cancellationToken);
        }
        ...
        public virtual IPagedList<TResult> GetPagedList<TResult>(Expression<Func<TEntity, TResult>> selector,
            ...
            where TResult : class
        {
            return GetAll(predicate, orderBy, include, disableTracking, ignoreQueryFilters).Select(selector).ToPagedList(pageIndex, pageSize);
        }
        ...
        public virtual Task<IPagedList<TResult>> GetPagedListAsync<TResult>(Expression<Func<TEntity, TResult>> selector,
            ...
            where TResult : class
        {
            return GetAll(predicate, orderBy, include, disableTracking, ignoreQueryFilters).Select(selector).ToPagedListAsync(pageIndex, pageSize, cancellationToken: cancellationToken);
        }
        ...
        public virtual TEntity? GetFirstOrDefault(Expression<Func<TEntity, bool>>? predicate = null,
                                         ...
                                         bool ignoreQueryFilters = false)
        {
            return GetAll(predicate, orderBy, include, disableTracking, ignoreQueryFilters).FirstOrDefault();
        }
        ...
        public virtual Task<TEntity?> GetFirstOrDefaultAsync(Expression<Func<TEntity, bool>>? predicate = null,
            ...
            CancellationToken cancellationToken = default)
        {
            return GetAll(predicate, orderBy, include, disableTracking, ignoreQueryFilters).FirstOrDefaultAsync(cancellationToken: cancellationToken);
        }
        ...
        public virtual TResult? GetFirstOrDefault<TResult>(Expression<Func<TEntity, TResult>> selector,
                                                  ...
                                                  bool ignoreQueryFilters = false)
        {
            return GetAll(predicate, orderBy, include, disableTracking, ignoreQueryFilters).Select(selector).FirstOrDefault();
        }
        ...
        public virtual Task<TResult?> GetFirstOrDefaultAsync<TResult>(Expression<Func<TEntity, TResult>> selector,
                                                  ...
                                                  CancellationToken cancellationToken = default)
        {
            return GetAll(predicate, orderBy, include, disableTracking, ignoreQueryFilters).Select(selector).FirstOrDefaultAsync(cancellationToken: cancellationToken);
        }
        ...
        public virtual void Delete(object id)
        {
            ...
            if (entityType == null)
            {
                throw new Exception("Error creating stub entity");
            }
